...
const App = (() => {
  ...
  function normalizeRitualDefinitions(value) {
    const doc = cloneObject(value);
  ...
  function normalizeData(data) {
    ...
    window.AppData.ritualDefinitions = normalizeRitualDefinitions(data.ritualDefinitions);
