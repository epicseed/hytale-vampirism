...
public class SkillLoader extends com.epicseed.epiccore.skill.data.SkillDataLoader<Ability, ModifierDef, ReusableDef, VampireState, StatDef> {
    ...
    public SkillLoader(com.epicseed.epiccore.skill.data.SkillDataPaths dataPaths,
                       SkillLoaderModelAdapter modelAdapter,
